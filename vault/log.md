...
## [2026-08-28] session | Трек «Оффер и продажи» развёрнут в полноценный раздел

Продолжение learning-roadmap: секция E выросла с врезки на ~20 строк до полного раздела (13 подсекций).

**Добавлено**: тест ниши из 5 вопросов, три продуктизированных оффера с чеками, анатомия одностраничного оффера, лестница из 3 ступеней (платная диагностика → ядро → ретейнер), value-based ценообразование с формулой цены проблемы и приёмом трёх опций Blair Enns, ранжированный лидген для соло, технические требования к холодной почте 2026 (DMARC p=quarantine, <0.3% жалоб, 2-3 ящика/домен, прогрев 4-6 недель, 30-50 писем/день), пятиэтапный разговор о продаже, переход проект → ретейнер, операционный минимум (права на промпты/датасеты, ответственность по метрике), 90-дневный спринт продаж.

**Ключевой вывод**: холодная почта — не первый канал для соло. Порядок: тёплая сеть → контент → узкий outbound. Метрика спринта — количество разговоров, не выручка.
